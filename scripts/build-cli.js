...
try {
  ...
  execSync('esbuild src/cli.ts --bundle --platform=node --target=node22 --minify --tree-shaking=true --external:@cursor/sdk --external:@cursor/sdk/* --external:ai --external:@ai-sdk/* --external:zod --outfile=dist/cli.js', {
    stdio: 'inherit',
    cwd: cliDir,
