...
|---|---|---|
| `@caeliq/ccr-shared` | `packages/shared` | `2.1.12` |
| `@caeliq/llms` | `packages/core` | `1.0.70` |
| `@caeliq/claude-code-router` | `packages/cli` | `2.1.12` |
...
- Push of a version tag: `v*.*.*` (example: `v2.1.12`)
