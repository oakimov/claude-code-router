...
|---|---|---|
| `@caeliq/ccr-shared` | `packages/shared` | `2.1.1` |
| `@caeliq/llms` | `packages/core` | `1.0.59` |
| `@caeliq/claude-code-router` | `packages/cli` | `2.1.1` |
...
- Push of a version tag: `v*.*.*` (example: `v2.1.1`)
