...
|---|---|---|
| `@caeliq/ccr-shared` | `packages/shared` | `2.1.2` |
| `@caeliq/llms` | `packages/core` | `1.0.60` |
| `@caeliq/claude-code-router` | `packages/cli` | `2.1.2` |
...
- Push of a version tag: `v*.*.*` (example: `v2.1.2`)
